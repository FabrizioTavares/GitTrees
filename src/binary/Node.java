...
public class Node implements utils.TreePrinter.PrintableNode{
    ...
    public void cloneToSelf(Node node){
    ...
    */
    public void printChildren() { //imprime os filhos e suas informações, se possível
        try {
            System.out.println("l: " + this.getLeft().getValue() + " | Object: " + this.getLeft());
        } catch (Exception e) {
            System.out.println("l: Empty");
        }
        try {
            System.out.println("r: " + this.getRight().getValue() + " | Object: " + this.getRight());
        } catch (Exception e) {
